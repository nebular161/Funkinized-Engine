...
class TitleState extends MusicBeatState {
	...
	function startIntro() {
		...
		logoBl.frames = Paths.getSparrowAtlas('menuUI/logoBumpin');
		...
		gfDance.frames = Paths.getSparrowAtlas('menuUI/gfDanceTitle');
		...
		titleText.frames = Paths.getSparrowAtlas('menuUI/titleEnter');
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('menuUI/newgrounds_logo'));
		ngSpr.visible = false;
			...
			for (i in lastBeat...curBeat) {
				switch (i + 1) {
					...
					case 4:
						deleteCoolText();
					case 5:
						createCoolText(['Not Asscociated', 'with']);
					case 7:
