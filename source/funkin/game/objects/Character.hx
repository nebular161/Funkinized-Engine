...
class Character extends FlxSprite /* Credits to Shadow Mario for the Character Hx code */
{
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				var characterPath:String = 'funkin/data/character-data/chars/' + curCharacter + '.json';
				var path:String = Paths.getPreloadPath(characterPath);
				if (!Assets.exists(path))
				{
					path = Paths.getPreloadPath('funkin/data/character-data/chars/' + DEFAULT_CHARACTER + '.json'); //If a character couldn't be found, change him to BF just to prevent a crash
				}
